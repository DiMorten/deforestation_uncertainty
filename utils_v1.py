...
def build_resunet_dropout3(input_shape, nb_filters, n_classes):
    ...
    res_block1 = resnet_block_spatial_dropout(input_layer, nb_filters[0], 1)
    pool1 = MaxPool2D((2 , 2), name='pool_net1')(res_block1)
    ...
    res_block4 = resnet_block_spatial_dropout(pool3, nb_filters[2], 4)
    
    res_block5 = resnet_block_spatial_dropout(res_block4, nb_filters[2], 5)
    
    res_block6 = resnet_block_spatial_dropout(res_block5, nb_filters[2], 6)
    
    upsample3 = Conv2D(nb_filters[2], (3 , 3), activation = 'relu', padding = 'same', 
                       name = 'upsampling_net3')(UpSampling2D(size = (2,2))(res_block6))
    
    upsample3 = SpatialDropout2D(dropout)(upsample3, training=True)
    ...
    upsample2 = SpatialDropout2D(dropout)(upsample2, training=True)
